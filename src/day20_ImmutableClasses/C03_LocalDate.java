...
public class C03_LocalDate {
    public static void main(String[] args) {
        ...
        LocalDate dogumTarihi3 = LocalDate.of(1991,8,14);
        LocalDate dogumTarihi4=  LocalDate.of(1992,11,28);
        System.out.println(dogumTarihi1.isLeapYear()); // true
        System.out.println(dogumTarihi2.isLeapYear()); // true
        System.out.println(dogumTarihi3.isLeapYear());// false
        System.out.println("======");
        System.out.println(dogumTarihi3.getDayOfWeek());
        System.out.println(dogumTarihi4.getDayOfWeek());
