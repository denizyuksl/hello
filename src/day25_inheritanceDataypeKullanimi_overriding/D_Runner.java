...
public class D_Runner {
    public static void main(String[] args) {
       /*
        ...
        System.out.println(kartal1.solunum);// B Akcigerle solunum yapar.
        System.out.println(kartal1.beslenme);// C et yerler
        System.out.println(kartal1.cogalma);// B yumurta ile cog.
        System.out.println(kartal1.omur);// A yasar  ve olur
        System.out.println(kartal1.kanat);//B kanatlidir
        System.out.println(kartal1.gaga);//C sivri gagalidir
        System.out.println(kartal1.pence);//C penceleri var

         B_Kuslar kartal2 = new C_AvciKuslar();
        System.out.println(kartal2.hareket);// A hareket ederler
        System.out.println(kartal2.solunum);// B Akcigerle solunum yapar.
        System.out.println(kartal2.beslenme);// A beslenirler
        System.out.println(kartal2.cogalma);// B yumurta ile cog.
        System.out.println(kartal2.omur);// A yasarlar ve olur
        ...
        System.out.println(kartal3.solunum);// A solunum yapar.
        System.out.println(kartal3.beslenme);// A beslenirler
        System.out.println(kartal3.cogalma);// A cogalır
        System.out.println(kartal3.omur);// A cogalır ve olur
